...
async def test_tracker_details(aresponses: ResponsesMockServer, auth_response, tracker_details):
...
async def test_tracker_hw_info(aresponses: ResponsesMockServer, auth_response, hw_info):
    mock_auth(aresponses, auth_response)
    aresponses.add(
        "graph.tractive.com",
...
async def test_tracker_pos_report(aresponses: ResponsesMockServer, auth_response, pos_report):
    mock_auth(aresponses, auth_response)
    aresponses.add(
        "graph.tractive.com",
...
async def test_tracker_positions_history(aresponses: ResponsesMockServer, auth_response, positions_history):
    mock_auth(aresponses, auth_response)
    aresponses.add(
        "graph.tractive.com",
...
async def test_tracker_buzzer_control(aresponses: ResponsesMockServer, auth_response, active, action):
    mock_auth(aresponses, auth_response)
    aresponses.add(
        "graph.tractive.com",
...
async def test_tracker_led_control(aresponses: ResponsesMockServer, auth_response):
    mock_auth(aresponses, auth_response)
    aresponses.add(
        "graph.tractive.com",
...
async def test_tracker_live_tracking(aresponses: ResponsesMockServer, auth_response):
    mock_auth(aresponses, auth_response)
    aresponses.add(
        "graph.tractive.com",
...
async def test_tracker_repr(aresponses: ResponsesMockServer, auth_response):
    mock_auth(aresponses, auth_response)
