...
class TestTrackableObjectDetails:

    async def test_details(self, aresponses: ResponsesMockServer, auth_response, pet_details):
    ...
    async def test_health_overview(self, aresponses: ResponsesMockServer, auth_response, health_overview):
